...
?>
			...
			<div class="modifierannonce">
				<form method="post" action="modifierannonceadmin.php?idannonce=<?php echo $idannonce?>">
				<?php echo 'Modifier l\'annonce numéro : ',$idannonce?> </br>
				...
				<a href="supprimerannonce.php?idannonce=<?php echo $idannonce;?>" id="suppannonce">Supprimer cette annonce</a>
				<a href="Modifiercompteadmin.php?idmembre=<?php echo $donnees['id_membre'];?>" id="modifinfoadmin">Modifier le compte associé</a>
				</div>
<?php
		}
